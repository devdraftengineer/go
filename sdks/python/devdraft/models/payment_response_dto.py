...
class PaymentResponseDto(BaseModel):
    ...
    amount: Union[StrictFloat, StrictInt] = Field(description="The amount charged")
    currency: StrictStr = Field(description="The currency code")
    status: StrictStr = Field(description="Payment status")
    timestamp: StrictStr = Field(description="Timestamp of the payment")
    __properties: ClassVar[List[str]] = ["id", "amount", "currency", "status", "timestamp"]
