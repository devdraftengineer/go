...
create_stable_payment_intent_dto_instance = CreateStablePaymentIntentDto.from_json(json)
# print the JSON string representation of the object
print(CreateStablePaymentIntentDto.to_json())

# convert the object into a dict
create_stable_payment_intent_dto_dict = create_stable_payment_intent_dto_instance.to_dict()
# create an instance of CreateStablePaymentIntentDto from a dict
create_stable_payment_intent_dto_from_dict = CreateStablePaymentIntentDto.from_dict(create_stable_payment_intent_dto_dict)
```
